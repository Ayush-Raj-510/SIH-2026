...
interface HeaderProps {
  ...
  // The Period selector is no longer displayed in the UI.
  ...
  return (
    <header className="border-b border-[#D0CFCB] bg-[#F8F7F4] text-[#141414] sticky top-0 z-40 shadow-xs">
      ...
      {/* =========================================================
          ...
          ========================================================= */}
      <div className="bg-[#141414] text-[#E4E3E0] px-4 py-1.5 border-b border-[#2A2A2A]">
        ...
        <div className="flex items-center justify-between gap-4 min-w-0">
          ...
          <div className="flex items-center gap-3 min-w-0 overflow-hidden">
            ...
            <span className="flex items-center gap-1.5 font-bold text-emerald-400 tracking-wide text-[11px] whitespace-nowrap">
            ...
            <span className="text-[#B8B6B0] flex items-center gap-1 text-[11px] whitespace-nowrap">
            ...
            <span className="text-[#B8B6B0] font-mono text-[11px] whitespace-nowrap">
              Active Run:{' '}
            ...
            <span className="text-[#444444] hidden md:inline shrink-0">
              |
            </span>

            <span className="text-[#B8B6B0] font-mono text-[11px] hidden md:inline whitespace-nowrap">
              SHA-256:{' '}
              <span className="text-[#E4E3E0]">
                {formatShortHash(datasetHash, 8)}
              </span>
            </span>
          ...
          <div className="flex items-center gap-3 shrink-0">
            ...
            <div className="relative" ref={menuRef}>
              ...
              <button
                ...
                className="flex items-center gap-2 px-2.5 py-1 rounded bg-[#242424] hover:bg-[#2F2F2F] border border-[#3E3E3E] text-xs text-[#E4E3E0] transition cursor-pointer whitespace-nowrap"
              >
                ...
                <div className="absolute right-0 mt-1.5 w-80 bg-[#1A1A1A] border border-[#3A3A3A] rounded-xl shadow-2xl z-50 p-4 text-[#E4E3E0] text-xs space-y-3">
                  ...
                  <div className="space-y-1.5 text-[11px] bg-[#222222] p-2.5 rounded-lg border border-[#2E2E2E]">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <span
                        className="text-[#CCCCCC] truncate max-w-[170px]"
            ...
            <button
              onClick={onLogout}
              className="px-2 py-1 bg-[#242424] hover:bg-[#381F24] hover:border-[#882233] text-[#CCCCCC] hover:text-[#FFAAAA] border border-[#3E3E3E] rounded text-xs transition cursor-pointer flex items-center gap-1.5 whitespace-nowrap"
